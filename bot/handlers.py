    ...
    try:
        ...
        if lang == "fr":
            referral_text = (
                ...
                f"👥 Directs actifs: {active_directs}\n\n"
                f"📈 <b>PALIERS DE COMMISSION:</b>\n"
                f"10% base pour tous\n"
                f"12.5% membres Alpha\n"
                f"15% + Alpha GRATUIT à 5 clients\n"
                f"25% à 10 clients\n"
                f"30% à 20 clients\n"
                f"40% à 30+ clients\n\n"
                f"{next_tier_text}\n\n"
                f"💸 <b>COMMENT ÇA MARCHE:</b>\n"
                f"1. Partage ton lien unique\n"
                f"2. Ton ami s'inscrit à Risk0\n"
                f"3. Tu gagnes 10-40% de leur abonnement\n"
                f"4. Commission GARANTIE chaque mois!\n\n"
                f"🔗 <b>TON LIEN:</b>\n"
            ...
            referral_text = (
                ...
                f"👥 Active directs: {active_directs}\n\n"
                f"📈 <b>COMMISSION TIERS:</b>\n"
                f"10% base for everyone\n"
                f"12.5% Alpha members\n"
                f"15% + FREE Alpha at 5 clients\n"
                f"25% at 10 clients\n"
                f"30% at 20 clients\n"
                f"40% at 30+ clients\n\n"
                f"{next_tier_text}\n\n"
                f"💸 <b>HOW IT WORKS:</b>\n"
                f"1. Share your unique link\n"
                f"2. Friend subscribes to Risk0\n"
                f"3. You earn 10-40% of their subscription\n"
                f"4. Commission GUARANTEED every month!\n\n"
                f"🔗 <b>YOUR LINK:</b>\n"
                f"<code>{referral_link}</code>\n\n"
                f"📊 <b>YOUR STATS:</b>\n"
                f"👥 Referrals: {stats['total']['count']}\n"
